...
int8_t direct[24] = {
    ...
    -21,-12,+8,+19,     // N,N,N,N
    +21,+12,-8,-19,     // N,N,N,N
    +10,+10,+11,+9,     // P,P,P,P (white)
    -10,-10,-11,-9      // P,P,P,P (black)
};
...
//***********************************************************
uint8_t dpoint[7] = {
    20,16,8,0,4,0,0     // black pawn, white pawn, N, B, R, Q, K
};
...
//***********************************************************
uint8_t dcount[7] = {
    4,4,8,4,4,8,8       // black pawn, white pawn, N, B, R, Q, K
};
...
//***********************************************************
uint64_t padding2[2];
ML_HEAD PLYIX[20];   // only the link pointers of each ML are used
ML *    PLYIX_alloc[20];
